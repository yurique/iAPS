...
class FoodSearchRouter {
    ...
    func searchFoodsByText(_ query: String) async throws -> [OpenFoodFactsProduct] {
        try await ConfigurableAIService.shared.analyzeFoodQuery(query: query, telemetryCallback: nil)
    ...
    func searchFoodByBarcode(_ barcode: String) async throws -> OpenFoodFactsProduct? {
        do {
            return try await ConfigurableAIService.shared.analyzeBarcode(barcode: barcode, telemetryCallback: nil)
        } catch {
